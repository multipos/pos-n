    ...
    model(0)
{
    ...
    ui->payTo->setPlaceholderText(tr("Enter a PoS-N Coin address (e.g. 1zCDq6drGXfBgkt7F3dnofdG822Ymiw9Hq)"));
...
void SendCoinsEntry::setModel(WalletModel *model)
{
    ...
    {
        connect(model->getOptionsModel(), SIGNAL(displayUnitChangedPoSNCoin(int)), this,
...
#endif
        ui->payTo->setToolTip(qstt.arg(COLOR_NAME[nColor]).arg("1zCDq6drGXfBgkt7F3dnofdG822Ymiw9Hq"));
        break;
    default:
